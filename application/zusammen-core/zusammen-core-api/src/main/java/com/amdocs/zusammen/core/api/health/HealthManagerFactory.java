...
public abstract class HealthManagerFactory
    extends AbstractComponentFactory<HealthManager> {

  public static HealthManagerFactory getInstance() {
    return AbstractFactory.getInstance(HealthManagerFactory.class);
  }

  public abstract HealthManager createInterface(SessionContext context);
}
